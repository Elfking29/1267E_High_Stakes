		...
		if (!use_partner){
			...
			*/
			if (print_counter%50==0){
				...
				print_counter += 10;
				//End printing
			if (Con2.get_digital(E_CONTROLLER_DIGITAL_L1) && Con2.get_digital(E_CONTROLLER_DIGITAL_R1)){
				use_partner=true;
			}
		}	
		else{
			if (Con2.get_digital(E_CONTROLLER_DIGITAL_L2) && Con2.get_digital(E_CONTROLLER_DIGITAL_R2)){
				use_partner=false;
			}
